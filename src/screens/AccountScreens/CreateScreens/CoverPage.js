			...
			<View style={[style.mainDown,{alignItems:'center'}]}>
				...
				<View style={styles.btnView1}>
					...
					<Pressable 
						...
						onPress={()=>{navigation.navigate('CreateScrapImages',{userId:route.params.userId,name:name,description:description,image:image,lattitude:lattitude,longitude:longitude,templateId:route.params.templateId})}}
					>
