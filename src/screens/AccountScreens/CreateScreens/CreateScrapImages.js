...
import {createScrapbook} from "../../fetchData/Scrapbooks/uploadScrap.js"
const CreateScrapImages = ({navigation,route}) => {
	...
	const uploadScrapbook = async ()=>{
		let base64 = ""
		const result = createScrapbook(route.params.userId,route.params.name,route.params.description,route.params.lattitude,route.params.longitude,0,base64,route.params.templateId)
		console.log(result)
	}
    return (
        <View style={style.container}>
            <StatusBar barStyle={"light-content"}/>
            <View style={[style.downMain,{flexDirection:'row',alignItems:'center'}]}>
